CREATE TABLE `botInventories_ItemHistory` (
...
ALTER TABLE `botInventories_ItemHistory` 
...
ALTER TABLE `botInventories_ItemHistory` 
  ADD CONSTRAINT `botInventoryAdditionalItemDataId` FOREIGN KEY (additionalItemDataId)
    REFERENCES botInventories_AdditionalItemData(id);

ALTER TABLE `botInventories_ItemHistory` 
  ADD CONSTRAINT `botInventoryBotId` FOREIGN KEY (botid)
    REFERENCES bots(id);

ALTER TABLE `botInventories_ItemHistory` 
  ADD CONSTRAINT `botInventoryItemId` FOREIGN KEY (itemid)
    REFERENCES items(id);